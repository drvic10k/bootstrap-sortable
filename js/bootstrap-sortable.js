...
(function ($) {
  ...
  $.bootstrapSortable = function () {
    ...
    $('table.sortable').each(function () {
      ...
      $this.find('thead th').each(function (index) { var $this = $(this); bsSort[index] = $this.attr('data-defaultsort'); if(bsSort[index] != null){ bsSort[index] == 'asc' ? 'desc' : 'asc'; $this.click();}});
    });
  };
